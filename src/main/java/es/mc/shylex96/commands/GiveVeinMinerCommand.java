...
public class GiveVeinMinerCommand implements CommandExecutor {
    ...
    private static final String ENCHANTMENT_NAME = "VeinMiner";
    ...
    public boolean onCommand (CommandSender sender, Command command, String label, String[] args) {
        if (sender instanceof Player) {
            ...
            if (validTools.contains(item.getType())) {
                ...
                meta.setDisplayName(ChatColor.GOLD + ENCHANTMENT_NAME);
